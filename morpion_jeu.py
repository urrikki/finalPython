...
def ai():
    ...
    elif rOrJ == 0 and nTour == 5:

        dessin.create_line(100*1+8, 100*1+8, 100*1+96, 100*1+96, width = 5, fill = 'gold')
        dessin.create_line(100*1+8, 100*1+96, 100*1+96, 100*1+8, width = 5, fill = 'gold')
